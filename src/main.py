...
class app:
    ...
    def home(self):
        self.clear_page()
        render_home(self.username, self.establishments, self.food_items, self.signin, self.signup, self.signout, self.reports_root, self.my_establishment_reviews, self.my_food_reviews)
